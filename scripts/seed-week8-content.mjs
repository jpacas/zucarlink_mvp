...
const contentItems = [
  {
    ...
    source_url: 'https://www.isosugar.org/sugarsector/sugar',
  ...
  },
  {
    ...
    source_url: 'https://www.fenasucro.com.br/pt-br/blog/sobre-a-fenasucro/abertura-da-31--fenasucro---agrocana--setor-quer-o-brasil-como-p.html',
    cover_image_url: null,
  ...
  },
  {
    ...
    source_url: 'https://www.fas.usda.gov/data/brazil-sugar-annual-11',
    cover_image_url: null,
  ...
  },
  {
    ...
    source_url: 'https://www.fenasucro.com.br/pt-br/blog/sobre-a-fenasucro/fenasucro---agrocana-trends-e-lancada-em-agosto-com-programacao-.html',
    cover_image_url: null,
  ...
  },
  {
    ...
    source_url: 'https://www.fenasucro.com.br/',
    cover_image_url: null,
  ...
  },
  {
    ...
    source_url: 'https://www.ice.com/agriculture/sugar',
    cover_image_url: null,
  ...
  },
  {
    ...
    source_url: 'https://www.fenasucro.com.br/pt-br/blog/sobre-a-fenasucro/fenasucro---agrocana-destaca-esg-no-setor-bioenergetico-com-espa.html',
    cover_image_url: null,
...
// Agenda curada de la industria azucarera para planificar la asistencia de los
// técnicos. La PRIMERA tag indica el tipo y define el color de marca en la
// tarjeta: 'técnico' → verde, 'feria' → naranja, 'mercado' → cian.
// NOTA: las fechas marcadas con "(fechas por confirmar)" en el resumen deben
// verificarse contra la fuente oficial antes de comunicarlas.
const events = [
  {
    id: '20000000-0000-4000-8000-000000000001',
    title: '13º Congreso ATALAC 2026',
    slug: 'congreso-atalac-2026',
    summary:
      'Congreso de la Asociación de Técnicos Azucareros de Latinoamérica y el Caribe: referencia técnica regional en agronomía, fábrica y bioenergía.',
    start_date: '2026-08-10',
    end_date: '2026-08-14',
    city: 'Ribeirão Preto',
    country: 'Brasil',
    organizer: 'ATALAC / STAB',
    source_url: 'https://www.atalac2026.com/',
    cover_image_url: null,
    tags: ['técnico', 'latinoamérica'],
    status: 'published',
  },
  {
    id: '20000000-0000-4000-8000-000000000002',
    title: 'Fenasucro & Agrocana 2026',
    slug: 'fenasucro-agrocana-2026',
    summary:
      'La mayor feria del sector sucroenergético: bioenergía, automatización, proveedores y actualización tecnológica para fábrica y campo.',
    ...
    source_url: 'https://www.fenasucro.com.br/',
    cover_image_url: null,
    tags: ['feria', 'bioenergía'],
    status: 'published',
  },
  {
    id: '20000000-0000-4000-8000-000000000003',
    title: 'XVII Congreso de Técnicos Azucareros (ATAGUA)',
    slug: 'congreso-atagua-2026',
    summary:
      'Encuentro centroamericano de técnicos azucareros con foco en sostenibilidad, innovación y competitividad de la agroindustria. (Fechas por confirmar.)',
    start_date: '2026-09-09',
    end_date: '2026-09-11',
    city: 'La Antigua Guatemala',
    country: 'Guatemala',
    organizer: 'ATAGUA / CENGICAÑA',
    source_url: 'https://www.atagua.org/',
    cover_image_url: null,
    tags: ['técnico', 'centroamérica'],
    status: 'published',
  },
  {
    id: '20000000-0000-4000-8000-000000000004',
    title: 'The India Sugar & Bio-Energy Conference (2ª edición)',
    slug: 'india-sugar-bioenergy-conference-2026',
    summary:
      'Conferencia global sobre mercado del azúcar, etanol y bioenergía organizada por la industria azucarera india.',
    start_date: '2026-09-09',
    end_date: '2026-09-10',
    city: 'Nueva Delhi',
    country: 'India',
    organizer: 'ISMA',
    source_url: 'https://www.theindiasugarandbioenergyconference.com/',
    cover_image_url: null,
    tags: ['mercado', 'etanol'],
    status: 'published',
  },
  {
    ...
    title: '26th International DATAGRO Conference on Sugar and Ethanol',
    slug: 'international-datagro-conference-sugar-ethanol-2026',
    summary:
      'Conferencia internacional de referencia en mercado, política pública, bioenergía y diversificación del sector azucarero. (Fechas por confirmar.)',
    start_date: '2026-10-26',
    end_date: '2026-10-27',
    city: 'São Paulo',
    country: 'Brasil',
    organizer: 'DATAGRO',
    source_url: 'https://www.datagroconferences.com/en/eventos/international-datagro-conference-sugar-ethanol-2026/',
    cover_image_url: null,
    tags: ['mercado', 'bioenergía'],
    status: 'published',
  },
  {
    id: '20000000-0000-4000-8000-000000000006',
    title: 'ISO International Sugar Seminar 2026',
    slug: 'iso-international-sugar-seminar-2026',
    summary:
      'Seminario anual de la Organización Internacional del Azúcar: lectura experta de mercado, política y perspectivas globales del sector.',
    start_date: '2026-11-30',
    end_date: '2026-12-01',
    city: 'Londres',
    country: 'Reino Unido',
    organizer: 'International Sugar Organization',
    source_url: 'https://www.isosugar.org/events',
    cover_image_url: null,
    tags: ['mercado', 'global'],
    status: 'published',
  },
  {
    ...
    title: 'The Dubai Sugar Conference 2027',
    slug: 'dubai-sugar-conference-2027',
    summary:
      'Punto de encuentro internacional para comercio, refinación y análisis de mercado del azúcar. (Fechas por confirmar.)',
    start_date: '2027-02-08',
    end_date: '2027-02-10',
    city: 'Dubái',
    country: 'Emiratos Árabes Unidos',
    organizer: 'Kingsman / S&P Global',
    source_url: 'https://www.thedubaisugarconference.com/',
    cover_image_url: null,
    tags: ['mercado', 'comercio'],
    status: 'published',
  },
  {
    id: '20000000-0000-4000-8000-000000000008',
    title: 'ISSCT Agricultural Engineering, Agronomy & Extension Workshop',
    slug: 'issct-ag-engineering-agronomy-workshop-2027',
    summary:
      'Taller técnico de la Comisión Agrícola de la ISSCT sobre ingeniería agrícola, agronomía y extensión aplicadas a la caña.',
    start_date: '2027-04-11',
    end_date: '2027-04-15',
    city: 'Baton Rouge',
    country: 'Estados Unidos',
    organizer: 'ISSCT / ASSCT',
    source_url: 'https://issct.org/activities/workshops/',
    cover_image_url: null,
    tags: ['técnico', 'agronomía'],
    status: 'published',
  },
  {
    id: '20000000-0000-4000-8000-000000000009',
    title: 'XXXIII Congreso ISSCT 2028',
    slug: 'issct-congress-2028-guatemala',
    summary:
      'Congreso mundial de la Sociedad Internacional de Técnicos de la Caña de Azúcar, sede Guatemala, organizado por ATAGUA: el evento insignia para los técnicos centroamericanos. (Fechas por confirmar.)',
    start_date: '2028-01-30',
    end_date: '2028-02-03',
    city: 'Ciudad de Guatemala',
    country: 'Guatemala',
    organizer: 'ISSCT / ATAGUA',
    source_url: 'https://www.issct.org/',
    cover_image_url: null,
    tags: ['técnico', 'centroamérica'],
    status: 'published',
  },
  {
    ...
    title: 'The Dubai Sugar Conference 2026',
    slug: 'dubai-sugar-conference-2026',
    summary:
      'Edición 2026 del foro internacional de comercio y mercado del azúcar celebrado en Dubái.',
  ...
  },
  {
    ...
    title: 'Africa Sugar Conference 2026',
    slug: 'africa-sugar-conference-2026',
    summary:
      'Encuentro enfocado en mercado, política sectorial, sostenibilidad y nuevas rutas de ingresos en azúcar y etanol.',
    start_date: '2026-04-14',
    end_date: '2026-04-15',
    city: 'Nairobi',
    country: 'Kenia',
    organizer: 'Informa Connect',
    source_url: 'https://informaconnect.com/africa-sugar/',
    cover_image_url: null,
    tags: ['mercado', 'sostenibilidad'],
    status: 'published',
  },
  {
    id: '20000000-0000-4000-8000-000000000012',
    title: '19th CITI ISO DATAGRO NY Sugar & Ethanol Conference',
    slug: 'citi-iso-datagro-ny-sugar-ethanol-conference-2026',
    summary:
      'Evento de referencia para seguir señales globales de azúcar y etanol con foco ejecutivo y comercial.',
    start_date: '2026-05-13',
    end_date: '2026-05-13',
    city: 'Nueva York',
    country: 'Estados Unidos',
    organizer: 'DATAGRO + ISO',
    source_url: 'https://www.datagroconferences.com/en/eventos/citi-iso-datagro-ny-conference-2-2026/',
    cover_image_url: null,
    tags: ['mercado', 'etanol'],
    status: 'published',
  },
...
const priceItems = [
  ...
  },
  {
    ...
    source_url: 'https://www.ice.com/products/37089080/White-Sugar',
  ...
  },
  {
    ...
    source_name: 'B3',
    source_url: 'https://www.b3.com.br/pt_br/market-data-e-indices/servicos-de-dados/market-data/consultas/mercado-de-derivativos/metodologia/metodologia-do-indicador-de-precos-do-etanol-hidratado-paulinia-sp-esalq-b3/',
  ...
  },
  {
    ...
    source_url: 'https://www.ccee.org.br/en/web/guest/ccee',
